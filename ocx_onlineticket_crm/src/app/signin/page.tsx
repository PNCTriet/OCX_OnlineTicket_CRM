              ...
              <div>
                  ...
                  <div className="flex items-center justify-between">
                    <label htmlFor="checkboxLabelOne" className="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                      <div className="relative">
                        ...
                        />
                        <div className={`mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] ${keepLoggedIn ? 'border-blue-500 bg-blue-500' : 'bg-transparent border-gray-300 dark:border-gray-700'}`}>
                ...
                <div className="mt-5">
                  <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    ...
                    <Link href="/signup" className="text-blue-500 hover:text-blue-600 dark:text-blue-400">Sign Up</Link>
                  </p>
                </div>
              </div>
            </div>
